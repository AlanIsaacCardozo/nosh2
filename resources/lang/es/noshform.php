...
return [
    ...
    */
    ...
    "footer1" => "This document was generated by Simplenote ChartingSystem",
    ...
    "clear" => "Clear",
    "signature" => "Signature",
    "new_user_message" => "You are invited to use the Simplenote ChartingSystem for",
    ...
    "password_reset1" => "This message is to notify you that you have reset your password with Simplenote ChartingSystem",
    "password_reset2" => "To finish this process, please click on the following link or point your web browser to",
    "password_reset3" => "Reset password to Simplenote ChartingSystem",
    ...
    "install1" => "Please fill out the entries to complete the installation of Simplenote ChartingSystem.",
    ...
    "submit" => "Submit",
    "uma_patient_centric_designate3" => "An Authorization Server has not been found in the same domain as your Simplenote ChartingSystem installation.",
    "uma_patient_centric_designate4" => "You will need to designate the URL of your Authorization Server to proceed with using Simplenote ChartingSystem",
