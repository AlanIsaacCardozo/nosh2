...
return [
    ...
    */
    ...
    "invite_title" => "Accept your invitation to access Simplenote ChartingSystem",
    ...
    "follow_these_steps" => "Follow these steps to get running.",
    "show_me" => "Show me",
    "calendar" => "Calendar",
    "patientandcontacts" => "Patients & Contacts",
    "reports" => "Reports",
    "settings" => "Settings",
    ...
    // Email
    "api_provider_register1" => "This message is sent to you from one of your patients who has a Simplenote ChartingSystem electronic health record system.",
    ...
    "api_uma_register2" => ", who has a Simplenote ChartingSystem electronic health record system.",
